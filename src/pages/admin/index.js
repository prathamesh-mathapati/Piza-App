...
const Admin = () => {
  const [fromData, setFromdata] = useState({ name: "",
    category: "",
    foodType: "",
    price: "",
    description: "",
  ...
  const handleChanges = (e) => {
    setFromdata((prevData) => {
      ...
      console.log(fromData,"fromData2",{[e.target.name]: e.target.value});
            ...
            <div className="mb-4">
...

              {
                ...
                Object.keys(fromData.price).map(key=>{
                    return (  <div key={key} className="ml-4 mb-4">
                        <label
className="block text-white dark:text-gray-500  text-sm font-bold mb-2 "                          htmlFor={key}
                        >
                          {key}
                        </label>
                        <input
