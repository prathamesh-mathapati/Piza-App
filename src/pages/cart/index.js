              ...
              {state.length > 0 ? (
                <>
                  ...
                  <button
                    ...
                    className="border dark:border-gray-400 border-gray-900 rounded p-2 bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700  text-gray-100 hover:font-bold"
                  >
                    Check Out
                  </button>
                </>
